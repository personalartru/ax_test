...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230226_axel_3ece5b239a5a94114638_20260625121337_archive.zip';
        const ARCHIVE_SIZE       = '149034636';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '3ece5b2-25121337';
        const SECONDARY_PACKAGE_HASH = '1333f36-25121337';
        const VERSION            = '1.5.13.1';
